...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "2026",
    endDate: "Present",
    title: "Vide Code & AI UI/UX Designer",
    company: "Self-employed",
    description: [
      "Leveraging advanced AI tools to write efficient code and accelerate the development of real-world applications.",
      "Creating tech and coding-related video content to share knowledge and document my coding journey.",
      "Building a diverse portfolio of full-stack web applications and continuously learning new technologies.",
      "Developing practical solutions and actively exploring modern web frameworks like Next.js and Tailwind CSS."
    ],
    skills: [
      SkillNames.JS,
      SkillNames.HTML,
